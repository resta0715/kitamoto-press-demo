...
| FAQ | 6問（おすすめ／ニュアンス／オフ無料／中田／安い／フィルイン） |
| 内部リンク | ハブ「戸塚ネイルサロン特集」・北本7選・for-salons |

**狙うキーワード（優先順）:** 戸塚 ネイルサロン おすすめ → 戸塚 ネイル → 戸塚 ネイル ニュアンス → 戸塚 ネイル オフ無料 → 中田 ネイル → 中田 ネイルサロン

### 戸塚ネイル記事 — キーワードマトリクス（2026-06-10 更新）

| キーワード | 記事内対応セクション | 競合難易度 | 備考 |
|-----------|---------------------|-----------|------|
| 戸塚 ネイルサロン おすすめ | title / H1 / 導入 / FAQ① / JSON-LD | 高 | メインCVクエリ。GSC週次監視 |
| 戸塚 ネイル | 導入・hero-lead・FAQ・outro | 高 | ボリューム最大級。広義クエリ |
| 戸塚 ネイル ニュアンス | H2 `#nuance-off` / FAQ② / tree house・Reyel・CHOU CHOU | 中 | HPB掲載メニューに基づく記述のみ |
| 戸塚 ネイル オフ無料 | H2 `#nuance-off` / FAQ③ | 中 | **常時オフ無料は誇大禁止**。クーポン条件を明記 |
| 中田 ネイル | Reyelセクション / 導入 / FAQ④ | 中 | 中田駅徒歩2分を強調 |
| 中田 ネイルサロン | Reyel H3・エリア表記 / 早見表 / FAQ④ | 中 | 本記事掲載はReyelのみ |

**HPB調査メモ（2026-06-10）**

| サロン | ニュアンス | オフ無料（HPB） |
|--------|-----------|----------------|
| Reyel | ◎ 大人ニュアンス・トレンド定額 | 次回付替えオフ無料クーポン／オフ代込みメニュー |
| tree house nail | ◎ HPB「ニュアンス◎」インクニュアンス | ご新規オフ無料・オフ込みクーポン |
| &CHOU CHOU nail | ◎ ニュアンス・韓国ネイル（HPB明記） | 初回オフ無料クーポン（条件あり） |
| le jardin | △ 定額デザイン中心 | ◎ 新規・4週間以内再来でオフ無料 |
| REMIA | △ トレンド・シンプル中心 | △ 特定メニューのみ初回オフ無料 |
